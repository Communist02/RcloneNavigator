...
OutputBaseFilename=rclone_navigator_x86_64_setup
SetupIconFile=..\app\resources\favicon.ico
...
Source: winfsp.msi; DestDir: {tmp}; Flags: ignoreversion deleteafterinstall
...
Filename: "msiexec.exe"; Parameters: "/i ""{tmp}\winfsp.msi"" /qb"; WorkingDir: {tmp}
